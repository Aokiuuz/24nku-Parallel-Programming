...
void MD5Hash_SIMD(string input[4],__m128i state[4])
{
    ...
    for(int i = 0;i < 4;i++)
    {
        ...
        __m128i tmp1 = _mm_set1_epi32(0xff);
        __m128i tmp2 = _mm_set1_epi32(0xff00);
        __m128i tmp3 = _mm_set1_epi32(0xff0000);
        __m128i tmp4 = _mm_set1_epi32(0xff000000);
