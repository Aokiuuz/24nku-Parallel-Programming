...
{
public:
    // 保留原始vector队列的插入顺序语义，用head下标避免erase(begin)搬移队列元素
    vector<PT> priority;
    ...
    double profile_generate_time = 0;
    double profile_newpt_time = 0;
    double profile_calprob_time = 0;
    double profile_queue_push_time = 0;
    double profile_queue_pop_time = 0;
    double profile_popnext_time = 0;
    long long profile_popnext_count = 0;
    long long profile_newpt_count = 0;
    long long profile_queue_push_count = 0;
};
